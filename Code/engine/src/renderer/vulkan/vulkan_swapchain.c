...
void vulkan_swapchain_recrate(vulkan_context* context, u32 width, u32 height, vulkan_swapchain* swapchain){
...
b8 vulkan_swapchain_acuire_next_image_index(vulkan_context* context, vulkan_swapchain* swapchain, u64 timeout_ns, VkSemaphore image_available_semaphore, VkFence fence, u32* out_image_index){
     ...
     if(result == VK_ERROR_OUT_OF_DATE_KHR){
         vulkan_swapchain_recrate(context, context->framebuffer_width, context->framebuffer_height, swapchain);
         return FALSE;
