...
b8 vulkan_device_create(vulkan_context* context) {
    ...
    b8 transfer_share_graphics_queue = context->device.graphics_queue_index == context->device.transfer_queue_index;
    u32 index_count = 1;
    ...
    VkPhysicalDeviceFeatures device_featues = {};
    device_featues.samplerAnisotropy = VK_TRUE; // Request anistropy

    VkDeviceCreateInfo device_create_info = {VK_STRUCTURE_TYPE_DEVICE_CREATE_INFO};
    device_create_info.queueCreateInfoCount = index_count;
    device_create_info.pQueueCreateInfos = queue_create_infos;
    device_create_info.pEnabledFeatures = &device_featues;
